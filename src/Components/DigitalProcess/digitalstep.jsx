                  ...
                  <AnimateOnScroll animation="fadeInDown" speed="normal">
                    <div className="d-flex flex-column gspace-2">
                      ...
                      <h2 className="title-heading">
                        Étapes Simples vers l'Équilibre Durable
                      </h2>
                    </div>
                  </AnimateOnScroll>
                </div>
                <div className="col">
                  <AnimateOnScroll animation="fadeInDown" speed="normal">
                    <div className="d-flex flex-column gspace-2 justify-content-end h-100">
                      <p>
                        Notre processus structuré assure un accompagnement
                        fluide et efficace de l'évaluation initiale au progrès
                        soutenu. Notre approche Corps-Esprit est notre garantie.
                      </p>
