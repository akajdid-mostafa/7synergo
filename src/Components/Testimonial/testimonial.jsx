                  ...
                  <div className="card card-testimonial-reviewer">
                    ...
                    <div className="d-flex flex-column flex-md-row flex-lg-column justify-content-center gspace-2">
                      <div className="testimonial-header-link-wrapper">
                        ...
                        <a href="#">Équilibre Mental & Ancrage Corporel</a>
                      </div>
                      <div className="testimonial-header-link-wrapper">
                        <i className="fa-regular fa-circle-check accent-color"></i>
                        <a href="#">Gestion des Émotions & Discipline</a>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="testimonial-header-wrapper-title">
                  <div className="card-testimonial-header-title">
                    <div className="sub-heading">
                      ...
                      <span>Ce que disent nos Partenaires</span>
                    </div>
                    <h2 className="title-heading">
                      Écoutez nos Clients Satisfaits, Vraies Histoires de Succès
                    </h2>
                    <p>
                      Découvrez comment nos bénéficiaires (écoles, clubs,
                      adultes) ont atteint un équilibre durable grâce à notre
                      solution intégrée Corps-Esprit.
                    </p>
                  </div>
                </div>
              </AnimateOnScroll>
